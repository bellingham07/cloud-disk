...
func TestGenerateChunkFile(t *testing.T) {
	...
	myFile, err := os.OpenFile("img/test.jpg", os.O_RDONLY, 0666)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMergeChunkFile(t *testing.T) {
	myFile, err := os.OpenFile("test2.jpg", os.O_CREATE|os.O_WRONLY|os.O_APPEND, os.ModePerm)
	if err != nil {
		t.Fatal(err)
	}
	fileInfo, err := os.Stat("img/test.jpg")
...
func TestCheck(t *testing.T) {
	// 获取第一个文件的信息
	file1, err := os.OpenFile("img/test.jpg", os.O_RDONLY, 0666)
	if err != nil {
		t.Fatal(err)
	}
	...
	// 获取第二个文件的信息
	file2, err := os.OpenFile("test2.jpg", os.O_RDONLY, 0666)
	if err != nil {
		t.Fatal(err)
	}
